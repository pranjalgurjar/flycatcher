              ...
              <div className="tp-product-details-thumb-wrapper tp-tab d-sm-flex">
                <nav>
                  ...
                  >
                    ...
                    >
                      <img
                        src="img/product/details/nav/product-details-nav-1.jpg"
                        alt=""
                      />
                    </button>
                    <button
                    ...
                    >
                      <img
                        src="img/product/details/nav/product-details-nav-2.jpg"
                        alt=""
                      />
                    </button>
                    <button
                    ...
                    >
                      <img
                        src="img/product/details/nav/product-details-nav-3.jpg"
                        alt=""
                      />
                    </button>
                    <button
                    ...
                    >
                      <img
                        src="img/product/details/nav/product-details-nav-4.jpg"
                        alt=""
                      />
                    </button>
                    <button
                    ...
                    >
                      <img
                        src="img/product/details/nav/product-details-nav-5.jpg"
                        alt=""
                      />
                    </button>
                  </div>
                ...
                <div className="tab-content m-img" id="productDetailsNavContent">
                  ...
                  >
                    <div className="tp-product-details-nav-main-thumb">
                      <img
                        src="img/product/details/main/product-details-main-1.jpg"
                        alt=""
                      />
                    </div>
                  </div>
                  ...
                  >
                    <div className="tp-product-details-nav-main-thumb">
                      <img
                        src="img/product/details/main/product-details-main-2.jpg"
                        alt=""
                      />
                    </div>
                  </div>
                  ...
                  >
                    <div className="tp-product-details-nav-main-thumb">
                      <img
                        src="img/product/details/main/product-details-main-3.jpg"
                        alt=""
                      />
                    </div>
                  </div>
                  ...
                  >
                    <div className="tp-product-details-nav-main-thumb">
                      <img
                        src="img/product/details/main/product-details-main-4.jpg"
                        alt=""
                      />
                    </div>
                  </div>
                  ...
                  >
                    <div className="tp-product-details-nav-main-thumb">
                      <img
                        src="img/product/details/main/product-details-main-5.jpg"
                        alt=""
                      />
                    </div>
                  </div>
                            ...
                            <div className="row">
                              <div className="col-lg-6">
                                <div className="tp-product-details-desc-content pt-25">
                                  ...
                                  <p>
                                    With a slim design, a vibrant entertainment
                                ...
                                <div className="tp-product-details-desc-content">
                                  ...
                                  <p>
                                    S Pen is a bundle of writing instruments in one.
                              ...
                              <div className="col-lg-6">
                                <div className="tp-product-details-desc-thumb">
                                  <img
                                    src="img/product/details/desc/product-details-desc-1.jpg"
                                    alt=""
                                  />
                                </div>
                              </div>
                          ...
                          <div className="tp-product-details-desc-item  pb-75">
                            <div className="row">
                              <div className="col-lg-7">
                                <div className="tp-product-details-desc-thumb">
                                  <img
                                    src="img/product/details/desc/product-details-desc-2.jpg"
                                    alt=""
                                  />
                                </div>
                              </div>
                            ...
                            <div className="row">
                              <div className="col-xl-12">
                                <div className="tp-product-details-desc-banner text-center m-img">
                                  ...
                                  <img
                                    src="img/product/details/desc/product-details-desc-3.jpg"
                                    alt=""
                                  />
                                </div>
                              </div>
