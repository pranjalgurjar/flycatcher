      ...
      <div className="container">
        <div className="row align-items-center">
          <div className="col-xl-1 col-lg-1 col-md-4 col-6">
            <div className="logo">
              <a href="index.html">
                <img src="img/logo/logo.png" alt="logo" height={150} />
              </a>
            </div>
          </div>
          ...
          <div className="col-xl-3 col-lg-3 col-md-8 col-6">
            <div className="tp-header-main-right d-flex align-items-center justify-content-end">
              <div className="tp-header-login d-none d-lg-block">
                <a href="Signup" className="d-flex align-items-center">
                  ...
                  <div className="tp-header-login-content d-none d-xl-block">
                    <span>Hello, Sign Up Your Account</span>
                        ...
                        <li>
                          ...
                          <ul>
                            <li>
                              <a href="shop.html">
                                <img
                                  src="img/header/menu/menu-1.jpg"
                                  alt=""
                                />
                              </a>
                            </li>
                        ...
                        <li>
                          ...
                          <ul>
                            <li>
                              <a href="shop.html">
                                <img
                                  src="img/header/menu/menu-2.jpg"
                                  alt=""
                                />
                              </a>
                            </li>
                        ...
                        <li>
                          ...
                          <ul>
                            <li>
                              <a href="shop.html">
                                <img
                                  src="img/header/menu/menu-3.jpg"
                                  alt=""
                                />
                              </a>
                            </li>
            ...
            <div className="col-xl-7 col-lg-7">
              <div className="main-menu menu-style-1">
                <nav className="tp-main-menu-content">
                  <ul>
                    <li>
                      <a href="index.html">About Flycatcher</a>
                    </li>
                    <li className="has-dropdown has-mega-menu">
                      <a href="shop.html">Photo Album</a>
                        ...
                        <div className="row">
                          ...
                          <div className="col-lg-3">
                            <div className="shop-mega-menu-img">
                              <img
                                src="img/menu/product/menu-product-img-1.jpg"
                                alt=""
                              />
                          ...
                          <div className="col-lg-3">
                            <div className="shop-mega-menu-img">
                              <img
                                src="img/menu/product/menu-product-img-2.jpg"
                                alt=""
                              />
                              <div className="shop-mega-menu-btn">
                                <a
                    ...
                    <li className="has-dropdown has-mega-menu">
                      <a href="shop.html">Corporate Gifts</a>
                      <div className="shop-mega-menu tp-submenu tp-mega-menu">
                        <div className="row">
                          <div className="col-lg-2">
                            <div className="shop-mega-menu-list">
